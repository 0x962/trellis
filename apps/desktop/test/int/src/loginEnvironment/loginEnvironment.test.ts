...
import { loginEnvironment } from "../../../../src/loginEnvironment/loginEnvironment.ts";
...
test("shell startup errors do not expose environment values in the desktop error", async () => {
