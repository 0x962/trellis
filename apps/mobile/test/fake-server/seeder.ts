import type { ActorRef, Priority } from "@trellis/api";
import { addActivity } from "./refs";
import { seedFiles } from "./seedFiles";
import { newId, type ProjectRow, type State, statusesOf, type TicketRow } from "./state";
...
export const createSeeder = (state: State, now: number) => {
	...
	return { ago, byNumber, addTicket, addStatusActivity, addFieldActivity, addComment, ...seedFiles(state, ago) };
};
