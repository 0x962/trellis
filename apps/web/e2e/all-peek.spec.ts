...
// /all/table is the table across every project. The project chip narrows it
// to the tickets this spec seeds. Every other spec writes to the same
// server, so without the chip a seeded row can sit below the fold.
