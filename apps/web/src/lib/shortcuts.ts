...
export const shortcuts: readonly Shortcut[] = [
	...
	{ id: "listExtendArrowDown", keys: "shift+down", scope: "list", label: "Extend the selection down" },
	{ id: "listExtendArrowUp", keys: "shift+up", scope: "list", label: "Extend the selection up" },
	{ id: "listSelectAll", keys: "mod+a", scope: "list", label: "Select every row" },
	...
	{ id: "boardSelect", keys: "x", scope: "board", label: "Select or clear the card" },
	{ id: "boardExtendDown", keys: "shift+j", scope: "board", label: "Extend the selection down" },
	{ id: "boardExtendUp", keys: "shift+k", scope: "board", label: "Extend the selection up" },
	{ id: "boardSelectAll", keys: "mod+a", scope: "board", label: "Select every card of the column" },
	{ id: "boardStatus", keys: "s", scope: "board", label: "Change the status" },
	{ id: "boardPriority", keys: "p", scope: "board", label: "Set the priority" },
	{ id: "boardParent", keys: "shift+p", scope: "board", label: "Set the parent" },
	{ id: "boardProject", keys: "m", scope: "board", label: "Move to a project" },
	{ id: "boardLabels", keys: "l", scope: "board", label: "Set the labels" },
	{ id: "boardEpic", keys: "e", scope: "board", label: "Set the epic" },
