import { FlowArrow, GitPullRequest, MagnifyingGlass, Sparkle, Ticket, Tray } from "@phosphor-icons/react";
import type { ReactElement } from "react";

export type NavTarget = "/needs-you" | "/search" | "/all" | "/reviews" | "/ai/personas" | "/ai/flows";

export type NavRow = { to: NavTarget; label: string; icon: ReactElement };

// The six fixed destinations. The static shell sidebar paints them before
