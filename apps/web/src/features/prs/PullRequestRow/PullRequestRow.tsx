...
import { askedForReview, type LinkedPullRequest, type TicketSummary } from "@trellis/api";
...
export function PullRequestRow({ ticket, pr }: PullRequestRowProps) {
	return (
		...
		>
			<PrGlyph state={pr.state} isQueued={pr.isQueued} askedForReview={askedForReview(pr)} />
