...
describe("MarginFrame", () => {
	...
	// the browser's own error page, which says nothing about margin.
	...
	// which would make margin call GitHub for a diff nobody reads.
	test("asks margin's own origin once, and frames no page before the reply", async () => {
