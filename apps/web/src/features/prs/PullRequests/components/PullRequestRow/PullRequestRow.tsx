...
import { ActorChip, CheckRibbon, cx } from "@trellis/ui";
...
// row that gains a check pushes nothing below it.
export function PullRequestRow({ ticket, pr }: PullRequestRowProps) {
	...
	return (
		<div className="flex flex-col gap-1">
			<div
				data-pr-row={pr.id}
				className={cx("flex flex-col rounded-md border border-border bg-surface", !expanded && "h-14")}
			>
