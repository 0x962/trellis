import type { EpicSummary, Label, LabelGroup, Priority, ProjectSummary, Status, TicketSummary } from "@trellis/api";
...
export const setEpic = (bulk: BulkWrite, rows: readonly TicketSummary[], epic: EpicSummary | null): Promise<void> =>
	bulk.update(
		...
		{
			row: { epic: epic === null ? null : { id: epic.id, ref: epic.ref, name: epic.name } },
