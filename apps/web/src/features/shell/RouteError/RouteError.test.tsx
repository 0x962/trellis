...
describe("features/shell/RouteError", () => {
	...
	test("a missing route file while offline shows Server offline", () => {
		renderWithProviders(<RouteError error={chunkError} />, { path: "/all/table", actor: "navid", liveStatus: "down" });
	...
	test("a missing route file while online names the new build and offers a reload", () => {
		renderWithProviders(<RouteError error={chunkError} />, { path: "/all/table", actor: "navid", liveStatus: "live" });
