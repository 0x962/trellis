...
// picker rows, then Sub-tickets and Branch, then Created and Updated. The
// peek grid has the same rows in the same order and shows Sub-tickets only
// when the ticket has one. Created shows the actor of the `ticket.created`
// activity row. Updated shows the last actor, with the live dot while an
// agent is at work, and the save state of the description.
