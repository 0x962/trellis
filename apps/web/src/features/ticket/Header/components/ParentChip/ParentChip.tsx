...
export function ParentChip({ parent, title }: ParentChipProps) {
	...
	return (
		<button
			...
			className="inline-flex h-5 max-w-60 shrink items-center gap-1.5 rounded-sm border border-border bg-surface px-1.5 text-xs text-fg-muted transition duration-hover hover:border-border-strong hover:text-fg focus-visible:outline-2 focus-visible:outline-accent focus-visible:outline-offset-2"
		>
