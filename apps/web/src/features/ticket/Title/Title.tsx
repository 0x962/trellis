	...
	return (
		<div className={cx("flex flex-col gap-2", className)}>
			<textarea
				...
				className="block w-full resize-none overflow-hidden border-0 bg-transparent p-0 font-mono text-2xl font-semibold tracking-tight text-fg outline-none [field-sizing:content] focus:outline-none focus-visible:outline-none pointer-coarse:min-h-11"
			/>
			{conflict !== null && (
				<ConflictNotice
