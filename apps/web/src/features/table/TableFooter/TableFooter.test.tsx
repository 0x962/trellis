...
describe("features/table/TableFooter", () => {
	...
	test("states the ticket count, the selected count, and the active sort", () => {
		const view = render(<TableFooter total={42} selected={3} sort="-updatedAt" />);
		...
		view.rerender(<TableFooter total={1} selected={0} sort="-createdAt" />);
