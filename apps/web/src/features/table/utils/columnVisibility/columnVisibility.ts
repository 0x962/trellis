...
// project column repeats a project grouping or a view of one project, and
// a PR column with no PR in view is empty. A labels column is empty until
// one loaded row holds a label. A column the person hid stays hidden.
