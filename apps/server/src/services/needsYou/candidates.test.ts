...
beforeAll(async () => {
	...
	await db.execute(sql`INSERT INTO statuses (
		...
		(${startedStatus}, ${root}, 'In Progress', 'in-progress', 'started', 'fg-muted', 0, true, ${at}, ${at}),
		(${humanReviewStatus}, ${root}, 'Human Review', 'human-review', 'review', 'fg-muted', 1, false, ${at}, ${at})`);
