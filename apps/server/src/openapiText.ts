...
export const TAGS = [
	...
	},
	{
		name: "waves",
		description:
			"Waves: the ordered phases of one epic. A wave ref is a ULID or KEY/epic-slug/wave-slug. `GET /api/epics/{epic}` lists the waves of an epic.",
	},
...
export const BODY_EXAMPLES: Record<string, unknown> = {
	...
	"POST /waves": { epic: "OP/routine-runtime", name: "Phase 1: run state" },
	"PATCH /waves/{wave}": { name: "Phase 1: run state", slug: "phase-1" },
	"PUT /waves/order": {
		epic: "OP/routine-runtime",
		waves: ["OP/routine-runtime/phase-1", "OP/routine-runtime/phase-2"],
	},
