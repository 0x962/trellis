CREATE TABLE "epic_resources" (
	...
	CONSTRAINT "epic_resources_value_check" CHECK (("epic_resources"."kind" = 'doc' AND "epic_resources"."body" IS NOT NULL AND "epic_resources"."url" IS NULL AND "epic_resources"."blob_sha256" IS NULL)
				OR ("epic_resources"."kind" = 'link' AND "epic_resources"."body" IS NULL AND "epic_resources"."url" IS NOT NULL AND "epic_resources"."blob_sha256" IS NULL)
				OR ("epic_resources"."kind" IN ('image', 'file') AND "epic_resources"."body" IS NULL AND "epic_resources"."url" IS NULL AND "epic_resources"."blob_sha256" IS NOT NULL))
);
...
CREATE INDEX "epic_resources_blob_sha256_idx" ON "epic_resources" USING btree ("blob_sha256");--> statement-breakpoint
