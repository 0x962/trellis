...
// temp directory, never the LaunchAgents directory, the shim, or the gateway
// routes file of the person who runs the tests.
...
describe("the real home guard", () => {
	test("guardedPaths names the LaunchAgents directory, the shim directory, and the gateway routes file", () => {
