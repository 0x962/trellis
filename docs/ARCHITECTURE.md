...
`0023_slimy_krista_starr`. `0000_extensions` creates `pg_trgm`. `0001_init` holds
...
the order the migrator runs, and it lists 21 entries: the numbers 0009 to 0011
