...
A failed login shell returns a tool error, and the next tool request runs the login shell again. Existing agent controls use their saved launch environment.
