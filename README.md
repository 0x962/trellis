...
2. Assign a local coding agent to a ticket. Trellis gives the agent a separate Git worktree and keeps its conversation.
...
- Projects, repositories, custom statuses, epics, waves, tickets, and dependencies.
...
Install [Bun](https://bun.sh) 1.3 or newer, Git, Apple developer tools, and the [GitHub CLI](https://cli.github.com/). Run `gh auth login` if you want pull requests and checks. Install at least one supported agent CLI.
