...
4. Put the identifier in the branch name, for example KEY-42-dark-mode. A PR whose title, branch, or body carries KEY-42 links itself. To link one by hand: trellis pr add KEY-42 <url>
