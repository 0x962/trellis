...
describe("contract", () => {
	...
	test("every procedure has a method and a path and the sorted route table matches the plan", () => {
		...
		expect(table).toEqual([
			...
			"controller.actions GET /manager-actions",
			"controller.cancelAction POST /manager-actions/{id}/cancel",
			...
			"labelGroups.create POST /projects/{project}/label-groups",
			"labelGroups.createLabel POST /projects/{project}/label-groups/{group}/labels",
			"labelGroups.list GET /projects/{project}/label-groups",
