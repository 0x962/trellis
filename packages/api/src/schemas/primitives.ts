...
// A sub-project slug. `board`, `settings`, and `notes` are web routes under a
// project path, so a sub-project cannot take those names.
export const slugPattern = /^[a-z0-9]+(-[a-z0-9]+)*$/;

export const reservedSlugs: ReadonlySet<string> = new Set(["board", "settings", "notes"]);
