			...
			<Popover
				...
				trigger={
					<button
						...
						className="inline-flex h-8 w-full items-center gap-2 rounded-md border border-border bg-surface px-2.5 text-sm text-fg outline-none transition-colors duration-hover hover:border-border-strong active:bg-control-active focus-visible:border-accent focus-visible:ring-3 focus-visible:ring-accent-soft disabled:pointer-events-none disabled:opacity-50 pointer-coarse:h-11"
					>
						{value === null ? (
