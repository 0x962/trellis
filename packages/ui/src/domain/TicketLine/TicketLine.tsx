...
// A ticket identifier and the title, after an optional mark. The chain block
// draws its ticket rows with this line.
export function TicketLine({ identifier, title, link, mark }: TicketLineProps) {
